...
public class PtManagementApplication {
	...
	public PtManagementApplication(JobBuilderFactory jobBuilderFactory, StepBuilderFactory stepBuilderFactory) {
	...
	public static void main(String[] args) {
		SpringApplication.run(PtManagementApplication.class, args);
	}
